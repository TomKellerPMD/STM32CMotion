...
EXTERN_C HRESULT VCIAPI
  vciDeviceGetLicenseInfo(IN  HANDLE      hDevice,
                          OUT PVCILICINFO pInfo );

typedef HRESULT
  ( VCIAPI *PF_vciDeviceGetLicenseInfo)(IN  HANDLE      hDevice,
                                        OUT PVCILICINFO pInfo );

EXTERN_C HRESULT VCIAPI
  vciDeviceGetInfoExA(IN  HANDLE         hDevice,
                      OUT PVCIDEVINFOEXA pInfo );

typedef HRESULT
  ( VCIAPI *PF_vciDeviceGetInfoExA)(IN  HANDLE         hDevice,
                                    OUT PVCIDEVINFOEXA pInfo );

EXTERN_C HRESULT VCIAPI
  vciDeviceGetInfoExW(IN  HANDLE         hDevice,
                      OUT PVCIDEVINFOEXW pInfo );

typedef HRESULT
  ( VCIAPI *PF_vciDeviceGetInfoExW)(IN  HANDLE         hDevice,
                                    OUT PVCIDEVINFOEXW pInfo );

#ifdef UNICODE
#define VCIDEVINFOEX          VCIDEVINFOEXW
#define vciDeviceGetInfoEx    vciDeviceGetInfoExW
#define PF_vciDeviceGetInfoEx PF_vciDeviceGetInfoExW
#else
#define VCIDEVINFOEX          VCIDEVINFOEXA
#define vciDeviceGetInfoEx    vciDeviceGetInfoExA
#define PF_vciDeviceGetInfoEx PF_vciDeviceGetInfoExA
#endif //UNICODE

typedef VCIDEVINFOEX* PVCIDEVINFOEX;


EXTERN_C HRESULT VCIAPI
  vciDeviceGetAdapterInfoA(IN  HANDLE         hDevice,
                           OUT PVCIDEVIFINFOA pInfo );

typedef HRESULT
  ( VCIAPI *PF_vciDeviceGetAdapterInfoA)(IN  HANDLE         hDevice,
                                         OUT PVCIDEVIFINFOA pInfo );

EXTERN_C HRESULT VCIAPI
  vciDeviceGetAdapterInfoW(IN  HANDLE         hDevice,
                           OUT PVCIDEVIFINFOW pInfo );

typedef HRESULT
  ( VCIAPI *PF_vciDeviceGetAdapterInfoW)(IN  HANDLE         hDevice,
                                         OUT PVCIDEVIFINFOW pInfo );

#ifdef UNICODE
#define VCIDEVIFINFO               VCIDEVIFINFOW
#define vciDeviceGetAdapterInfo    vciDeviceGetAdapterInfoW
#define PF_vciDeviceGetAdapterInfo PF_vciDeviceGetAdapterInfoW
#else
#define VCIDEVIFINFO               VCIDEVIFINFOA
#define vciDeviceGetAdapterInfo    vciDeviceGetAdapterInfoA
#define PF_vciDeviceGetAdapterInfo PF_vciDeviceGetAdapterInfoA
#endif //UNICODE

typedef VCIDEVIFINFO* PVCIDEVIFINFO;


EXTERN_C HRESULT VCIAPI
  vciDeviceGetRuntimeInfo(IN  HANDLE        hDevice,
                          OUT PVCIDEVRTINFO pInfo );

typedef HRESULT
  ( VCIAPI *PF_vciDeviceGetRuntimeInfo)(IN  HANDLE        hDevice,
                                        OUT PVCIDEVRTINFO pInfo );
...
EXTERN_C HRESULT VCIAPI
  canMsgSwitchSigSetCloseDB( IN HANDLE hSigSet );

typedef HRESULT
  (VCIAPI *PF_canMsgSwitchSigSetCloseDB)( IN HANDLE hSigSet );
