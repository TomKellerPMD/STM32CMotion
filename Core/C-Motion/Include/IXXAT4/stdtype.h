...
******************************************************************************
 ...
 Compiler: MSVC, Borland C, LabWindows/CVI, GCC
...
#define _BI_ENDIAN      3
  ...
  #if !defined(_M_ARM_) && defined(_M_ARM)
    #define _M_BITS 32
    #define _M_ARM_ _M_ARM
    #define _M_BYTE_ORDER _BI_ENDIAN
  #elif !defined(_M_ARM64_) && defined(_M_ARM64)
    #define _M_BITS 64
    #define _M_ARM64_ _M_ARM64
    #define _M_BYTE_ORDER _BI_ENDIAN
  #elif !defined(_M_IX86_) && defined(_M_IX86)
    #define _M_BITS 32
  ...
  #include <stdint.h>
  #include <stddef.h>
  #if !defined(_M_ALPHA_) && defined(__alpha__)
    #define _M_BITS 32
    #define _M_ALPHA_ __alpha__
    #define _M_BYTE_ORDER _LITTLE_ENDIAN
  #elif !defined(_M_AMD64_) && defined(__amd64__)
    #define _M_BITS 64
    #define _M_AMD64_ __amd64__
    #define _M_BYTE_ORDER _LITTLE_ENDIAN
  #elif !defined(_M_ARM_) && defined(__arm__)
    #define _M_BITS 32
    #define _M_ARM_ __arm__
    #define _M_BYTE_ORDER _BI_ENDIAN
  #elif !defined(_M_ARMT_) && defined(__thumb__)
    #define _M_BITS 32
    #define _M_ARMT_ __thumb__
    #define _M_BYTE_ORDER _BI_ENDIAN
  #elif !defined(_M_ARM64_) && defined(__aarch64__)
    #define _M_BITS 64
    #define _M_ARM64_ __aarch64__
    #define _M_BYTE_ORDER _BI_ENDIAN
  #elif !defined(_M_BFIN_) && defined(__bfin__)
    #define _M_BITS 32
    #define _M_BFIN_ __bfin__
    #define _M_BYTE_ORDER _LITTLE_ENDIAN
  #elif !defined(_M_HPPA_) && defined(__hppa__)
    #define _M_BITS 64
    #define _M_BFIN_ __hppa__
    #define _M_BYTE_ORDER _BIG_ENDIAN
  #elif !defined(_M_IX86_) && defined(__i386__)
    #define _M_BITS 32
    #define _M_IX86_ __i386__
    #define _M_BYTE_ORDER _LITTLE_ENDIAN
  #elif !defined(_M_IX86_) && defined (__i486__)
    #define _M_BITS 32
    #define _M_IX86_ __i486__
    #define _M_BYTE_ORDER _LITTLE_ENDIAN
  #elif !defined(_M_IX86_) && defined (__i586__)
    #define _M_BITS 32
    #define _M_IX86_ __i586__
    #define _M_BYTE_ORDER _LITTLE_ENDIAN
  #elif !defined(_M_IX86_) && defined (__i686__)
    #define _M_BITS 32
    #define _M_IX86_ __i686__
    #define _M_BYTE_ORDER _LITTLE_ENDIAN
  #elif !defined(_M_IA64_) && defined(__ia64__)
    #define _M_BITS 64
    #define _M_IA64_ __ia64__
    #define _M_BYTE_ORDER _BI_ENDIAN
  #elif !defined(_M_M68K_) && defined(__m68k__)
    #define _M_BITS 32
    #define _M_M68K_ __m68k__
    #define _M_BYTE_ORDER _BIG_ENDIAN
  #elif !defined(_M_MIPS_) && defined(__mips__)
    #define _M_BITS 32
    #define _M_MIPS_ __mips__
    #define _M_BYTE_ORDER _BI_ENDIAN
  #elif !defined(_M_PPC_) && defined(__ppc__)
    #define _M_BITS 32
    #define _M_PPC_ __ppc__
    #define _M_BYTE_ORDER _BI_ENDIAN
  #elif !defined(_M_PPC64_) && defined(__ppc64__)
    #define _M_BITS 64
    #define _M_PPC64_ __ppc64__
    #define _M_BYTE_ORDER _BI_ENDIAN
  #elif !defined(_M_SPARC_) && defined(__sparc__)
    #define _M_BITS 64
    #define _M_SPARC_ __sparc__
    #define _M_BYTE_ORDER _BI_ENDIAN
  #elif !defined(_M_SH_) && defined(__sh__)
    #define _M_BITS 32
    #define _M_SH_ __sh__
    #define _M_BYTE_ORDER _BI_ENDIAN
  #endif

  #ifndef _M_BITS
    #define _M_BITS __INTPTR_WIDTH__
  #endif
...
#define RESTRICT DECLSPEC_RESTRICT
  ...
  #if defined(MICROSOFT_C) || defined(BORLAND_C) || defined(NILABWIN_C)
    #define DECLSPEC_DLLEXPORT __declspec(dllexport)
  #elif defined(GNU_C)
    #if defined(_WIN32) || defined(__CYGWIN__)
      #define DECLSPEC_DLLEXPORT __attribute__ ((dllexport))  
    #else
...
#ifndef DLLEXPORT
#define DLLEXPORT DECLSPEC_DLLEXPORT
#endif
  ...
  #elif defined(GNU_C)
    #if defined(_WIN32) || defined(__CYGWIN__)
      #define DECLSPEC_DLLIMPORT __attribute__ ((dllimport))
    #else
...
#ifndef DLLIMPORT
#define DLLIMPORT DECLSPEC_DLLIMPORT
#endif


#ifndef DECLSPEC_DLLINTERN
  #if defined(MICROSOFT_C) || defined(BORLAND_C) || defined(NILABWIN_C)
    #define DECLSPEC_DLLINTERN
  #elif defined(GNU_C)
    #if defined(_WIN32) || defined(__CYGWIN__)
      #define DECLSPEC_DLLINTERN
    #else
      #define DECLSPEC_DLLINTERN  __attribute__ ((visibility ("hidden")))
    #endif
  #else
    #define DECLSPEC_DLLINTERN
  #endif
...
#ifndef DLLINTERN
#define DLLINTERN DECLSPEC_DLLINTERN
#endif
...
#if defined(BUILD_DLL) || defined(BUILD_DSO)
 #define DLL_PUBLIC  DECLSPEC_DLLEXPORT
 #define DLL_PRIVATE DECLSPEC_DLLINTERN
#else
 #define DLL_PUBLIC
 #define DLL_PRIVATE
#endif
 ...
 ****************************************************************************/
 ...
 #elif defined(GNU_C) && defined(_M_IX86_)
  #define SCALL __attribute__ ((stdcall))
 #else
  #define SCALL
 #endif
#endif
...
// boolean types
//
// WaSt: insertion of !defined(_KERNEL_MODE) for a test
//#if !defined(__cplusplus) && !defined(_KERNEL_MODE)
#if !defined(__cplusplus)
#if (MICROSOFT_C >= 1800) || (GNU_C >= 29500)
#include <stdbool.h>
#else
typedef int              bool;
#endif
