...
#ifdef _MATLAB_COMPAT_

typedef INT64 VCIID, *PVCIID;

#else //_MATLAB_COMPAT_
...
#define VCI_DEVIF_I2C        0x00010002 // inter-integrated circuit (I²C)
...
typedef struct _VCIDEVRTINFO
{
  ...
  UINT16 _rsvd_1;            // reserved

  UINT32 FwType;             // type of currently running firmware
  UINT32 FwStatus;           // current status of firmware (see VCI_DEVRTI_FWST_)
  UINT16 FwMajorVersion;     // firmware major version number
  UINT16 FwMinorVersion;     // firmware minor version number
  UINT16 FwRevisionNumber;   // firmware revision number
  UINT16 FwBuildNumber;      // firmware build number
  UINT16 FwReqSizeMax;       // maximum request packet size in bytes
  UINT16 FwResSizeMax;       // maximum response packet size in bytes
...
// firmware types
//
#define VCI_DEVRTI_FWTYPE_UNK     0  // unknown or custom firmware
#define VCI_DEVRTI_FWTYPE_FLD     1  // flash loader firmware
#define VCI_DEVRTI_FWTYPE_CCL     2  // CCL conform firmware
#define VCI_DEVRTI_FWTYPE_BAL     3  // BAL conform firmware

//
// firmware status flags
//
#define VCI_DEVRTI_FWST_UNKNOWN   0x00000000 // firmware status unknown
#define VCI_DEVRTI_FWST_RUNNING   0x00000001 // firmware running
#define VCI_DEVRTI_FWST_STOPPED   0x00000002 // firmware stopped
